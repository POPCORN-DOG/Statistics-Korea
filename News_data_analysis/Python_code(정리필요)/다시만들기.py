...
data['words'][:5]
del words; del k;
data.to_excel('C:/Users/USER/Desktop/1~8newsurl/data0923.xlsx',header=True) #저장하기'''

###형태소 분석한것을 이용하여 기사 단위로 word2vec 분석하기
embedding_model = Word2Vec(list(data50['words']), size=100, window = 6, min_count=5, workers=4, iter=100)
embedding_model.wv.save_word2vec_format('C:/Users/USER/Desktop/1~8newsurl/w2v0923')# 모델 저장'''
...
word = ['비대면','의료진','소상공인','취약계층','재택근무','원격수업','자영업자','배달','화상회의','고용','경제활동','간호사',
         ...
         '취업','채용','청년','저소득층','실업급여','유통업계','고용안정지원금','공유오피스']  #물류센터,유통업계 불가 나중에 단어 추가 해서 마지막으로 돌려 봐야 할듯
